...
os.system('adb shell screencap /storage/emulated/0/arknights-screen.png')
os.system('adb pull /storage/emulated/0/arknights-screen.png {to}'.format(to='./tmp/arknights-screen.png'))
